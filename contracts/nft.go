...
func (_Nft *NftTransactor) SafeMint(opts *bind.TransactOpts, to common.Address) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "safeMint", to)
}

// SafeMint is a paid mutator transaction binding the contract method 0x40d097c3.
//
// Solidity: function safeMint(address to) returns()
func (_Nft *NftSession) SafeMint(to common.Address) (*types.Transaction, error) {
	return _Nft.Contract.SafeMint(&_Nft.TransactOpts, to)
}

// SafeMint is a paid mutator transaction binding the contract method 0x40d097c3.
//
// Solidity: function safeMint(address to) returns()
func (_Nft *NftTransactorSession) SafeMint(to common.Address) (*types.Transaction, error) {
	return _Nft.Contract.SafeMint(&_Nft.TransactOpts, to)
}
